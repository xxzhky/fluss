...
/** An implementation of {@link SecurityTokenReceiver} which does nothing for test purpose. */
public class TestingSecurityTokenReceiver implements SecurityTokenReceiver {
    @Override
