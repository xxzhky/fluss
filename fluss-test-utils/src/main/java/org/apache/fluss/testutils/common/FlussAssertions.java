...
public class FlussAssertions {
     ...
     *     .extracting(FlussAssertions::chainOfCauses, FlussAssertions.STREAM_THROWABLE)
     * }</pre>
     */
    public static ListAssert<Throwable> assertThatChainOfCauses(Throwable root) {
        return assertThat(root).extracting(FlussAssertions::chainOfCauses, STREAM_THROWABLE);
    }
