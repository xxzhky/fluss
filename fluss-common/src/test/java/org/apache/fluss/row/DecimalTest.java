...
import static org.apache.fluss.utils.DecimalUtils.castToBoolean;
import static org.apache.fluss.utils.DecimalUtils.castToDecimal;
import static org.apache.fluss.utils.DecimalUtils.castToIntegral;
import static org.apache.fluss.utils.DecimalUtils.compare;
import static org.apache.fluss.utils.DecimalUtils.doubleValue;
import static org.apache.fluss.utils.DecimalUtils.subtract;
import static org.assertj.core.api.Assertions.assertThat;

/** Test for {@link org.apache.fluss.row.Decimal} class. */
public class DecimalTest {
    ...
    public void testNormal() {
        ...
        assertThat(Objects.requireNonNull(Decimal.zero(5, 2)).toBigDecimal().intValue())
                .isEqualTo(0);
        assertThat(Objects.requireNonNull(Decimal.zero(20, 2)).toBigDecimal().intValue())
                .isEqualTo(0);
