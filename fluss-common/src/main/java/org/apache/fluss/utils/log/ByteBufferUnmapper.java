 ...
 *
 * <p>The implementation was inspired by the one in Lucene's MMapDirectory.
 */
@Internal
public final class ByteBufferUnmapper {
     ...
     *
     * <p>This buffer cannot be referenced after this call, so it's highly recommended that any
     * fields referencing it should be set to null.
     *
        ...
        try {
            ...
            throw new UnsupportedOperationException(
                    "Unmapping is not supported on this platform, because internal "
                            + "Java APIs are not compatible with this fluss version",
                    e1);
        }
    }
