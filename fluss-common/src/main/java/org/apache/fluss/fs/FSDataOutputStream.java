 ...
 * {@link OutputStream} with some additional important methods.
 *
 ...
 * persistence via Fluss's FileSystem abstraction and the {@code FSDataOutputStream}.
 *
 * <h2>Thread Safety</h2>
 *
...
public abstract class FSDataOutputStream extends OutputStream {
     ...
     * can is only assumed after calls to {@link #close()}.
     *
