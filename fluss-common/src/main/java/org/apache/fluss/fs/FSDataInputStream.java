 ...
 *
 * <p>This extends the {@link InputStream} with methods for accessing the stream's {@link #getPos()
 * current position} and {@link #seek(long) seeking} to a desired position.
 *
 * @since 0.1
 */
@PublicStable
