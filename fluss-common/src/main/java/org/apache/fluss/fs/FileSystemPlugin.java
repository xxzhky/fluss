...
/**
 * A plugin to create file systems.
 *
 * @since 0.1
 */
@PublicEvolving
public interface FileSystemPlugin extends Plugin {
     ...
     * @param configuration the configuration used to create the file system.
     * @return A new instance of the specified file system.
     * @throws IOException Thrown if the file system could not be instantiated.
     */
    FileSystem create(URI fsUri, Configuration configuration) throws IOException;
}
