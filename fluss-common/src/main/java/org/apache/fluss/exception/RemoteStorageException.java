...
/**
 * Exception thrown when there is a remote storage error. This can be used as the base exception by
 * implementors of RemoteLogReader or RemoteLogMetadataManager to create extended exceptions.
 */
@PublicEvolving
