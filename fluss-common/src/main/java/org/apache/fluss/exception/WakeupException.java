 ...
 * {@code org.apache.fluss.client.table.scanner.log.LogScanner#wakeup()} can be used to break out of
 * an active {@code org.apache.fluss.client.table.scanner.log.LogScanner#poll(java.time.Duration)},
