...
/**
 * The mapping between a timestamp to a log record offset. The entry means that any record whose
 * timestamp is greater than timestamp must be at ot after that offset.
 */
public final class TimestampOffset implements IndexEntry {
