...
package org.apache.fluss.server.cli;
...
public interface ParserResultFactory<T> {
     ...
     * @throws FlussParseException Thrown on failures while parsing command line arguments
     */
    T createResult(@Nonnull CommandLine commandLine) throws FlussParseException;
}
