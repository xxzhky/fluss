...
public class FlinkHistogram implements Histogram {
    ...
    private final org.apache.fluss.metrics.Histogram wrapped;
    ...
    private static class FlinkHistogramStatistics extends HistogramStatistics {
        ...
        private final org.apache.fluss.metrics.HistogramStatistics wrapped;

        public FlinkHistogramStatistics(org.apache.fluss.metrics.HistogramStatistics wrapped) {
            this.wrapped = wrapped;
        }
